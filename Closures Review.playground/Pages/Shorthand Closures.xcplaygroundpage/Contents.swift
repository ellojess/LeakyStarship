...
/*:
 Let's go back to our event we were previously planning. We need to easily be able to add guests to our guest list, but we also want to be aware of any special requests they may have (you know how Sven only eats those rare olives from Spain).
