...
/*:
 ...
 We'll be using our `Guest struct` from the previous page. As a refresher, here's the struct:
 */
...
let nadia = Guest(name: "Nadia", age: 17)

blockOfCodeToPrintGuestInfo(nadia)
